...
#
# Script generated by Vivado on Sat Aug 30 21:41:52 -0400 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/cpu_project/Nexys_board_test/Nexys_board_test.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
